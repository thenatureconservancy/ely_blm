...
# Create clickable hyperlinks with BPS names and model codes
clickable_names <- sapply(seq_along(urls), function(i) {
  paste0('<a href="', urls[i], '" target="_blank">', bps_urls$BPS_NAME[i], ' (', bps_urls$BPS_MODEL[i], ')</a>')
})
...
*Note: the table is large-there are scroll bars on the side, and at the bottom for viewing.*
